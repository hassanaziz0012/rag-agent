...
async def generate_stream_response(api_key, prompt):
    """Generate a streaming response from the LLM."""
    llm = genai.Client(api_key=api_key)
    # Use the async iterator provided by the client
    resp = await llm.aio.models.generate_content_stream(
